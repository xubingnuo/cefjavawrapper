...
int CefV8HandlerImpl::AddRef(void){
	return (uintptr_t)jhandler_;	
}
int CefV8HandlerImpl::GetRefCt(void){
	return (uintptr_t)jhandler_;	
}
int CefV8HandlerImpl::Release(void){
							   ...
							   CefString& exception)
{
	...
	jobject params = CreateJNIObject(env,
		"org/limewire/cef/CefV8FunctionParams", NULL, 0);
	if(!params)
		return false;
